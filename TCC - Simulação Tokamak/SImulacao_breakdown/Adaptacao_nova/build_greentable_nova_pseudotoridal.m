...
p_central = 0.37;
r_ini=0.001;
out.r = linspace(r_ini,r0,Ng);
out.z = linspace(0,2*pi,Ng);
[x,y] = meshgrid(out.r,out.z);
...
if isave
    G = out;
    fname = ['/home/kevi/Área de Trabalho/TCC - Simulação Tokamak/SImulacao_breakdown/green_table/green_table_nova_' num2str(Ng) 'x' num2str(Ng) '_pseudo.mat'];
    save(fname,'-struct','G')
