function build_greentable_TCABR
...
W = load('/home/kevi/Desktop/TCC - Simulação Tokamak/SImulacao_breakdown/tcabr_vacuum_vessel');
EF = load('/home/kevi/Desktop/TCC - Simulação Tokamak/SImulacao_breakdown/tcabr_coils');
cnames = {'E1' 'E2' 'E3' 'E4' 'E5' 'E6' 'E7' 'F1' 'F2' 'F3' 'F4' 'F5' 'F6' 'F7' 'F8' 'F9' 'F10' 'F11' 'F12' 'F13' 'D01' 'D02' 'D03' 'D04'};

%% Calculating Green's functions between external coils and grid points
for icoils = 1:size(EF,1)
    Ro = EF(icoils,1);
    Zo = EF(icoils,2);
    dR = EF(icoils,3);
    dZ = EF(icoils,4);
...
if isave
    G = out;
    fname = ['/home/kevi/Desktop/TCC - Simulação Tokamak/SImulacao_breakdown/TCABR/green_table_' num2str(Ng) 'x' num2str(Ng) '.mat'];
    save(fname,'-struct','G')
